    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth ->
                        auth.requestMatchers("/authenticate", "/sign-up", "/rooms/**","/sessions/**","/resources/**","/conferences/**","/all-participants","/conference-participation/**","/all-organizers","/update-user/**","/get-user/**","/ws/**","/paiement/**","/feedback/**","/posts/**").permitAll() // Public endpoints
